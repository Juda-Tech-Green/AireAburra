...
from standardize import unificar_datos_estacion
...
#! Inicializar bot para SISAIRE
#val_bot = SisaireBot()

#? Actualizar base de datos aproximadamente 2 min
#val_bot.init_browser(ruta_1)
#val_bot.scan_all_stations()

#? Descargar datos de SISAIRE a partir de base de datos creada aproximadamente 3 h
